...
<?php
$disableEditItem="none";
$disableErrorPrice="none";
$errormsg="";
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['SaveMenuItem'])) {
        ...
        $nDes=$_POST['MenuItemDes'];
        $nprice=$_POST['MenuItemPrice'];
        if(!empty($nItem) && !empty($nDes) && !empty($nprice)){
            $disableErrorPrice="none";
            $errormsg="";
            if(is_numeric($_POST['MenuItemPrice'])){
                ...
                $errormsg="";
                $conn = new mysqli('localhost', 'root', '', 'food4u');
                $qrstr="SELECT `id`, `name`, `description`, `price`, `section`, `image` FROM `meals` WHERE `id`='".$mid."'";

                $disableEditItem="none";
            }
            else{
                $disableErrorPrice="block";
...
<!-- MENU -->
<div class="editMenuItem " style="display: <?php echo $disableEditItem;?>;">
                        ...
                        <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]?>">
                            ...
                            <table style="width: 80%;">
                                <tr>
                                    ...
                                    <td><input class="activTextField" type="text" name="MenuItemName" value="<?php echo $mName ?>"></td>
                                </tr>
                                <tr>
                                    <td><label for="MenuItemDes">Description: </label></td>
                                    <td><textarea cols="20" rows="4" class="activTextField" name="MenuItemDes" ><?php echo $mdescription ?></textarea></td>
                                </tr>
                                <tr>
                                    <td><label for="MenuItemPrice"></label>Price: </td>
                                    <td><input class="activTextField" type="text" name="MenuItemPrice" value="<?php echo $mprice ?>"></td>
                                </tr>
                                <tr>
...
<div class="errorMenuItem " style="display: <?php echo $disableErrorPrice;?>;">
                ...
                <div class="errorMenuItemContent" style="align: center">
                    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]?>">
                        <table style="width: 100%; border-collapse: separate; border-spacing: 0 20px;">
                            <tr><td style="text-align: center; vertical-align: middle;"><input class="errorTextField " disabled type="text" name="ErrorPrice" value="<?php echo $errormsg ?>"></td></tr>
                            ...
                            <table style="width: 100%; border-collapse: separate; border-spacing: 0 20px;">
                                ...
                                try{
                                    ...
                                    for($i=0;$i<$res->num_rows;$i++) {
                                        $row = $res->fetch_object();
                                        $sName = $row->sName;
                                        echo '<tr><td><h1 class="sectionName" style="text-align: center">'.$sName.'</h1></td></tr>';
                                        ...
                                        for($j=0;$j<$res2->num_rows;$j++) {
                                            ...
                                            <div >
                                                ...
                                                <div class="mealInfo">
                                                    ...
                                                    <p class="mealDes">'.$mdescription.'</p>
